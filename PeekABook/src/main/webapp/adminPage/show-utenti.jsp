									...
									<c:choose>
										<c:when test="${utente.admin==1}">
											...
											<p class="product-remove">
												...
												<a href="http://localhost:8080/PeekABook/RemoveAdmin?id=${utente.id}" style="text-decoration: none; color: white;"><span class="remove">Rimuovi Admin</span></a>
											</p>
										</c:when>
										<c:otherwise>
											<p class="product-remove">
												<i class="fas fa-plus" aria-hidden="true"></i>
												<a href="http://localhost:8080/PeekABook/SetAdmin?id=${utente.id}" style="text-decoration: none; color: white;"><span class="remove">Set Admin</span></a>
											</p>
										</c:otherwise>
									</c:choose>
								</div>
