			...
			<div class="product-items" style="display: flex;justify-content:center;flex-wrap: wrap;">
				<div class="product">
					<div class="product-img">
						<a href="http://localhost:8080/PeekABook/ShowAutori"><h1 style="font-weight: 500">Autori</h1></a>
					</div>
				</div>
				<div class="product">
					<div class="product-img">
						<a href="http://localhost:8080/PeekABook/AddProdotto"><h1 style="font-weight: 500; text-align:center">Aggiungi libro</h1></a>
					</div>
				</div>
			</div>
		</div>
